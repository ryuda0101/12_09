// export   →   이 컴포넌트를 밖에서 불러서 쓸 수 있도록 내보내주는 코드
// 불러들일 때에는 import / 출력할 때에는 export
// 상단에 변수 앞에 export를 써도 되고, 또는 가장 하단에 export default 변수명 으로 써도 된다.
export const faqs = [
    {
    ...
    {
        question:"Voluptas sequi architecto?",
