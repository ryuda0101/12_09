...
function Header() {
    ...
    let [gnbMenu] = useState(["Home","Listing","Property","Pages","Blog","Contact"]);
    // 리액트 안에서 스크립트 짜는 법
  ...
  return (
    <div id='header'>
        <div className='center'>
            <h1 className='logo'><a href='#'><img src='/img/sitelogo.jpg' alt='사이트로고'/></a></h1>
            <ul className='gnb'>
                {
                    ...
                    gnbMenu.map((item, index) => {
                        return (
                            ...
                            <li key={index}><a href="#">{gnbMenu[index]}</a></li>
                        )
                    })
                }
            </ul>
